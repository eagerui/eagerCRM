        ...
        >
          <View style={styles.section}>
            ...
            <Text
              ...
              role="heading"
            >
              Welcome PackagesEagerCRMMobile 👋
            </Text>
          </View>
          <View style={styles.section}>
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx build PackagesEagerCRMMobile
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Test
                </Text>
                ...
                >
                  nx test PackagesEagerCRMMobile
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint PackagesEagerCRMMobile
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p PackagesEagerCRMMobile -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project PackagesEagerCRMMobile
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
